...
public class PaisesTest extends SpringTest {
    ...
    //2- Hacer con junit un test que busque todos los paÃ­ses de habla inglesa.Â 
    @Test
    @Transactional
    @Rollback(true)
    ...
    //3- Hacer con junit un test que busque todos los paÃ­ses del continente europeo.Â 
    @Test
    @Transactional
    @Rollback(true)
